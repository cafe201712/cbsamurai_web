...
//    'debug' => filter_var(env('DEBUG', true), FILTER_VALIDATE_BOOLEAN),
     ...
     */
    'Security' => [
        'salt' => env('SECURITY_SALT', '0d292f3a7b43833de90f8e8e088319f516d987b68f012ed67f032b01e006a668'),
    ],
    ...
    'Cache' => [
        'default' => [
            'className' => env('CACHE_CLASS', 'File'),
            'path' => CACHE,
    ...
    'Error' => [
        'errorLevel' => E_ALL,
        'exceptionRenderer' => 'Cake\Error\ExceptionRenderer', //2017/10/17 Myzk
    ...
    'EmailTransport' => [
        'default' => [
            'className' => env('EMAIL_CLASS', 'Mail'),
    ...
    'Datasources' => [
        'default' => [
            ...
            'database' => env('DATABASE_DBNAME','cnsdev'),
