...
*/
        'Profile' => [
            ...
            'viewOthers' => true,
            'route' => ['plugin' => false, 'prefix' => false, 'controller' => 'Profile', 'action' => 'view'],
        ],
        'Key' => [
            'Session' => [
        ...
        'RememberMe' => [
            ...
            'active' => false,     // RememberMe は使わない（API 認証時にリダイレクトされたりして複雑になる為）
            'checked' => true,
            'Cookie' => [
                'name' => 'remember_me',
                'Config' => [
...
//            'CakeDC/Auth.RememberMe',     // RememberMe は使わない（API 認証時にリダイレクトされたりして複雑になる為）
            'Form' => [
                'fields' => [
                    'username' => 'email',
                ],
